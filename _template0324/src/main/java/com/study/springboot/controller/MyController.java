...
//        em2.merge(cart);
    ...
    public Cart delProduct() {
        Cart cart = em2.find(Cart.class, 28L);
        List<Product> productList = cart.getProducts();
        //detach, merge, remove 모두 사라짐
        System.out.println(productList);
        System.out.println(em2.contains(productList.get(0)));//true
        em2.remove(productList.get(0));
        System.out.println(em2.contains(productList.get(0)));//false
        System.out.println(productList);

//        //ALL일때 밑의 로직도 사용해야 삭제가 됨.
//        //또는 orphanRemoval=true 추가하면 됨
//        System.out.println(productList);
//        cart.getProducts().remove(productList.get(0)); //remove
//        System.out.println(productList);
//        em2.merge(cart);
        return cart;
    }
